/**
 * v0 by Vercel.
 * @see https://v0.dev/t/1wUeoNQ5mgU
          ...
          <div className="mx-auto max-w-3xl space-y-8">
            <div>
              ...
              <p className="text-muted-foreground">
                This is the main content area of the application. Here you can find information about our products,
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">Explore our wide range of products designed to meet your needs.</p>
                <Button>Learn More</Button>
              </div>
              <div className="space-y-4">
                <h2 className="text-2xl font-bold">Our Services</h2>
                <p className="text-muted-foreground">Discover the services we offer to help you achieve your goals.</p>
                <Button>Learn More</Button>
              </div>
            </div>
          </div>
        </main>
        <footer className="bg-muted p-4 sm:p-6">
